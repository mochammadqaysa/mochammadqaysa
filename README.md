...
[![Typing SVG](https://readme-typing-svg.herokuapp.com?font=Lexend+Deca&size=28&duration=3000&pause=500&color=09B6C2&center=true&vCenter=true&multiline=true&width=700&height=90&lines=Hi+there%2C+I'm+Qaysa+%F0%9F%91%8B;4%2B+Years+Mobile+%26+Fullstack+Developer)](https://git.io/typing-svg)
...
```dart
class Developer {
  final String name = "Mochammad Qaysa Al-Haq";
  final String role = "IT & Logistic Staff";
  final String basedIn = "Bandung, West Java, Indonesia 🇮🇩";
  final String experience = "4+ Years";
  final String currentlyAt = "PT. Tiara Indoprima";
}
```

## 🌠 My Holopin Collection Badges
...
[![GitHub Streak](https://streak-stats.demolab.com?user=mochammadqaysa&theme=meta-dark&hide_border=true&date_format=j%20M%5B%20Y%5D)](https://git.io/streak-stats)
